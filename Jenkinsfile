pipeline{
    ...
    stages{
        ...
        stage('Uploading War'){
            steps{
                 nexusArtifactUploader artifacts: [[artifactId: 'vprofile', classifier: '', file: 'target/vprofile-v2.war', type: 'war']], credentialsId: 'nexus-jenkins', groupId: 'com.visualpathit', nexusUrl: '18.119.109.18:8081', nexusVersion: 'nexus3', protocol: 'http', repository: 'vpro-maven', version: 'v2'
            }
        }
    }
}